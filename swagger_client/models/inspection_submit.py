...
class InspectionSubmit(object):
    ...
    def __init__(self, status=None, protocol=None):  # noqa: E501
        """InspectionSubmit - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._protocol = None
    ...
    @property
    def status(self):
        """Gets the status of this InspectionSubmit.  # noqa: E501

        Informa se a requisição foi concluída com sucesso.  # noqa: E501

        :return: The status of this InspectionSubmit.  # noqa: E501
        :rtype: bool
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this InspectionSubmit.

        Informa se a requisição foi concluída com sucesso.  # noqa: E501

        :param status: The status of this InspectionSubmit.  # noqa: E501
        :type: bool
        """
        if status is None:
    ...
    @property
    def protocol(self):
        """Gets the protocol of this InspectionSubmit.  # noqa: E501


        :return: The protocol of this InspectionSubmit.  # noqa: E501
        :rtype: Protocol
        """
    ...
    def protocol(self, protocol):
        """Sets the protocol of this InspectionSubmit.


        :param protocol: The protocol of this InspectionSubmit.  # noqa: E501
        :type: Protocol
        """
        if protocol is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InspectionSubmit, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InspectionSubmit):
            return False
